...
class FormBloc extends Bloc<FormEvent, FormsValidate> {
  ...
  bool _isNumberValid(int number) {
    return number >= 11111111 && number <= 79999999 ? true : false;
  }
    ...
    if (state.isFormValid) {
      try {
        ...
        if (updatedUser.isVerified!) {
          ...
          emit(state.copyWith(isFormValid: false,errorMessage: "Por favor, verifique su correo electrónico, haciendo clic en el enlace que se le envió por correo.",isLoading: false));
        }
